...
class AuthForm {
  ...
  render() {
    ...
    const loginBtn = this.NewElement.createNewElement('button', ['btn', 'login-btn'], 'Регистрация');
    ...
    this.NewElement.insertChilds(loginForm, [emailInput, nameInput, passwordInput, loginBtn, cancelBtn]);
